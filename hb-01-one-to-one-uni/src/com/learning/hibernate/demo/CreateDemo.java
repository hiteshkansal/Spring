	...
	public static void main(String[] args) {
		...
		try{
			...
			*/
			...
			Instructor inst = new Instructor("Ankur", "Doshi", "ankur@gmail.com");
			InstructorDetail instDet = new InstructorDetail("http://www.youtube.com/ankur", "bakar");
			
			//associate the object
			inst.setInstructorSetail(instDet);
